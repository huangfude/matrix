...
const DEFAULT_PROJECT_NAME: &str = "matrix-router";

/// Set a compile-time environment variable with the MATRIX_ROUTER_ prefix
macro_rules! set_env {
    ($name:expr, $value:expr) => {
        println!("cargo:rustc-env=MATRIX_ROUTER_{}={}", $name, $value);
    };
}
