"""
Unit tests for launch_router validation logic in matrix_cli.
...
import pytest
from matrix_cli.router.launch_router import RouterArgs, launch_router
...
class TestLaunchValidation:
    ...
    def test_pd_mode_allows_empty_urls(self):
        ...
        with patch("matrix_cli.router.launch_router.Router") as router_mod:
